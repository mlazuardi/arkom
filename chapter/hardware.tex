...
\ref{ARM}
\begin{figure}[ht]
\cetnerline{\includegraphics[width=1\textwidth]{figures/ARM.JPG}}
\caption{ARM}
\label{ARM}
\end{figure}
...
\ref{Cyrix}
\begin{figure}[ht]
\cetnerline{\includegraphics[width=1\textwidth]{figures/Cyrix.JPG}}
\caption{Cyrix}
\label{Cyrix}
\end{figure}
...
\ref{i5}
\begin{figure}[ht]
\cetnerline{\includegraphics[width=1\textwidth]{figures/i5.JPG}}
\caption{i5}
\label{IntelCore5}
\end{figure}
...
\ref{IntelPremium}
\begin{figure}[ht]
\cetnerline{\includegraphics[width=1\textwidth]{figures/IntelPentium.JPG}}
...
mati kembali, berarti terdapat masalah pada prosesor.
	\subsubsubsection{Pengidentifikasi}
